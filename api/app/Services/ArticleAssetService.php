...
class ArticleAssetService
{
    ...
    {        
        ...
        if($request->hasFile('article_asset')){
            ...
            $articleAsset = new \App\Models\ArticleAsset([
                ...
                'filename' => self::handleStoreFile($request->file('article_asset'), $directory = 'article_assets'),
            ]);

            return $articleAsset->save(); 
        }
    }
    ...
    {
        self::handleDeleteFile($articleAsset->filename,'article_assets');
