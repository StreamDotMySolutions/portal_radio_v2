    ...
    return (
        <div>
            ...
            >
                ...
                <FontAwesomeIcon
                    icon={['fas', 'folder']}
                    className={isSelected ? '' : 'text-warning'}
...
const ParentPicker = ({ currentId, value, onChange }) => {
    ...
    useEffect(() => {
        axios({ method: 'get', url: `${process.env.REACT_APP_BACKEND_URL}/directories/tree` })
    ...
    return (
        <div>
            ...
            <small className='text-muted mt-2 d-block'>
                ...
                Click a folder to set it as the parent. The current directory is disabled.
            </small>
        </div>
    )
}
