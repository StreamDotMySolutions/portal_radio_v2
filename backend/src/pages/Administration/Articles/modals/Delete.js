        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    <p className='text-muted small'>This action cannot be undone. All sub-articles will also be removed.</p>
                    <Form.Check
                        type='checkbox'
                ...
                <Modal.Footer>
                    ...
                    <Button variant='danger' disabled={isLoading || !acknowledged} onClick={handleSubmitClick}>
                        Delete
                    </Button>
                </Modal.Footer>
            </Modal>
